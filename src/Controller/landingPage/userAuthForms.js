function signUpForm()
{
    ...
    "<input type='submit' value='Sign Up' id='signUpButt' onclick='signUpRequest();'><span id='signUpText' onclick='logInForm();'>Alreay a user ?</span><span id='errorMessage'></span> ";
    setTimeout(() => {
...
function logInForm()
{
    ...
    let logInForm = "<input type='text' id='username' autocomplete='off' class='authInput' placeholder='Username' name='username'><br><br><input type='password' id='password' autocomplete='off' class='authInput' placeholder='Password' name='password'><br><br><input type='submit' value='Log in' id='loginButt' onclick='logInRequest();'><span id='signUpText' onclick='signUpForm();'>Sign up!</span><span id='errorMessage'></span> ";
    setTimeout(() => {
